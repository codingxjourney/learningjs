console.log("this is js tutorial 45");
...
meanings.addEventListener('click', () => {
    console.log("you clicked the get meanings");
    populate();
})
...
function populate() {
    ...
    results.forEach(element => {
        html += `<li class="list-group-item list-group-item-dark"> One of the definition of example is : ${element.definition} </li>`;
    });
